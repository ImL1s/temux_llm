...
# LD_LIBRARY_PATH required for ANY backend on this binary — libGemmaModelConstraintProvider.so
# is a hard dynamic dep regardless of --backend. Confirmed empirically (setup --help failure).
